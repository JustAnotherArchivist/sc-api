...
prefix = 'https://api.soundcloud.com/tracks?client_id=2t9loNQH90kzJcsFCODdigxfp325aq4z&app_version=1499947877&limit=200&ids='
prefixLength = len(prefix)
_logger = logging.getLogger('wpull.plugin.soundcloud-api-tracks')
